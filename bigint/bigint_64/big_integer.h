...
private:
    ...
    void mul_uint64_t(uint64_t const);

    void add_uint64_t(uint64_t const);

    void sub_uint64_t(uint64_t const);
    ...
    big_integer mul_uint64_t_return(uint64_t const x) const;

    uint64_t div_uint64_t(uint64_t const x);
